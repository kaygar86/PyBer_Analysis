...
While there are around 30 times more urban drivers in the PyBer pool than rural areas, the difference in total fares was only about 9 times more. This shows that each ride and driver is earning less in urban areas than in rural ones.
